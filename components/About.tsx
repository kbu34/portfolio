        ...
        <div className="col-span-2">
          ...
          >
            ...
            <p className="py-2 text-gray-600">
              ...
              since I encountered with software development was in high school.
              When the school offered a digital technology course. In that
              class, I learned the joy of seeing the code that I had written
              working and helping people with their daily lives. This made me
              realise that I wanted to make software development my career. I
              also started to learn more about how computers work in my own
              time. Which lead up to building my own desktop computer and
              installing Arch Linux on it in my university days.
            </p>
            <p className="py-2 text-gray-600">
              In university, I&apos;ve decided to major in software engineering.
              While I was studying, I came across many different problems, tools
              and solutions to solve those problems. I loved designing the
              solutions to those problems and implementing them. I&apos;ve also
              completed 2 summer internships. My time in university has taught
              me how to ship maintainable and readble code for future
              development cycle.
              <br />
